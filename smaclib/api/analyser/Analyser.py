...
class Iface(smaclib.api.module.Module.Iface):
  def analyse_video(video_id, info):
    """
  ...
  def analyse_slideshow(slideshow_id, info):
    """
  ...
  def analyse_document(document_id):
    """
...
class Client(smaclib.api.module.Module.Client):
  ...
  def analyse_video(self, video_id, info):
    """
    Analyze the video stream identified by asset_id to obtain segmentation
    information.
    ...
    self.send_analyse_video(video_id, info)
    return d

  def send_analyse_video(self, video_id, info):
    oprot = self._oprot_factory.getProtocol(self._transport)
    oprot.writeMessageBegin('analyse_video', TMessageType.CALL, self._seqid)
    args = analyse_video_args()
  ...
  def recv_analyse_video(self, iprot, mtype, rseqid):
    ...
    if mtype == TMessageType.EXCEPTION:
      ...
      return d.errback(x)
    result = analyse_video_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success != None:
      return d.callback(result.success)
    return d.errback(TApplicationException(TApplicationException.MISSING_RESULT, "analyse_video failed: unknown result"))

  def analyse_slideshow(self, slideshow_id, info):
    """
    Extract the slide images from the slideshow identified by asset_id.
    ...
    self._seqid += 1
    d = self._reqs[self._seqid] = defer.Deferred()
    self.send_analyse_slideshow(slideshow_id, info)
    return d

  def send_analyse_slideshow(self, slideshow_id, info):
    oprot = self._oprot_factory.getProtocol(self._transport)
    oprot.writeMessageBegin('analyse_slideshow', TMessageType.CALL, self._seqid)
    args = analyse_slideshow_args()
  ...
  def recv_analyse_slideshow(self, iprot, mtype, rseqid):
    d = self._reqs.pop(rseqid)
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(iprot)
      iprot.readMessageEnd()
      return d.errback(x)
    result = analyse_slideshow_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success != None:
      return d.callback(result.success)
    return d.errback(TApplicationException(TApplicationException.MISSING_RESULT, "analyse_slideshow failed: unknown result"))

  def analyse_document(self, document_id):
    """
    Analyze the document file identified by asset_id to extract the
    relevant information.
    ...
    self._seqid += 1
    d = self._reqs[self._seqid] = defer.Deferred()
    self.send_analyse_document(document_id)
    return d

  def send_analyse_document(self, document_id):
    oprot = self._oprot_factory.getProtocol(self._transport)
    oprot.writeMessageBegin('analyse_document', TMessageType.CALL, self._seqid)
    args = analyse_document_args()
    args.document_id = document_id
    args.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def recv_analyse_document(self, iprot, mtype, rseqid):
    d = self._reqs.pop(rseqid)
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(iprot)
      iprot.readMessageEnd()
      return d.errback(x)
    result = analyse_document_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success != None:
      return d.callback(result.success)
    return d.errback(TApplicationException(TApplicationException.MISSING_RESULT, "analyse_document failed: unknown result"))
...
class Processor(smaclib.api.module.Module.Processor, TProcessor):
  ...
  def __init__(self, handler):
    ...
    self._processMap["analyse_video"] = Processor.process_analyse_video
    self._processMap["analyse_slideshow"] = Processor.process_analyse_slideshow
    self._processMap["analyse_document"] = Processor.process_analyse_document
  ...
  def process_analyse_video(self, seqid, iprot, oprot):
    args = analyse_video_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = analyse_video_result()
    d = defer.maybeDeferred(self._handler.analyse_video, args.video_id, args.info)
    d.addCallback(self.write_results_success_analyse_video, result, seqid, oprot)
    return d

  def write_results_success_analyse_video(self, success, result, seqid, oprot):
    result.success = success
    oprot.writeMessageBegin("analyse_video", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_analyse_slideshow(self, seqid, iprot, oprot):
    args = analyse_slideshow_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = analyse_slideshow_result()
    d = defer.maybeDeferred(self._handler.analyse_slideshow, args.slideshow_id, args.info)
    d.addCallback(self.write_results_success_analyse_slideshow, result, seqid, oprot)
    return d

  def write_results_success_analyse_slideshow(self, success, result, seqid, oprot):
    result.success = success
    oprot.writeMessageBegin("analyse_slideshow", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_analyse_document(self, seqid, iprot, oprot):
    args = analyse_document_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = analyse_document_result()
    d = defer.maybeDeferred(self._handler.analyse_document, args.document_id)
    d.addCallback(self.write_results_success_analyse_document, result, seqid, oprot)
    return d

  def write_results_success_analyse_document(self, success, result, seqid, oprot):
    result.success = success
    oprot.writeMessageBegin("analyse_document", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class analyse_video_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('analyse_video_args')
...
class analyse_video_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('analyse_video_result')
...
class analyse_slideshow_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('analyse_slideshow_args')
...
class analyse_slideshow_result:
  """
  Attributes:
   - success
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('analyse_slideshow_result')
    if self.success != None:
      oprot.writeFieldBegin('success', TType.STRING, 0)
      oprot.writeString(self.success)
      oprot.writeFieldEnd()
...
class analyse_document_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('analyse_document_args')
...
class analyse_document_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('analyse_document_result')
    if self.success != None:
      oprot.writeFieldBegin('success', TType.STRING, 0)
      oprot.writeString(self.success)
      oprot.writeFieldEnd()
